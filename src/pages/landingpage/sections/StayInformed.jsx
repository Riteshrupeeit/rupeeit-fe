...
const StayInformed = () => {
    ...
    return (
        <section className="bg-black py-24 px-6 md:px-12 lg:px-24 flex flex-col lg:flex-row items-center justify-center gap-[48px] max-w-[1280px] mx-auto min-h-[700px]">
